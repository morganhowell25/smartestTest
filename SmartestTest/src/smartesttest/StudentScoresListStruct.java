 ...
 * @author csc190
 */
// Essentially I created a Struct that has three data members: and int and two Strings.
// This will make it much easier to handle the query results.
// This info will be displayed on the StudentScoresListScene in three columns: one for ids, one for unames, and one for scores.
public class StudentScoresListStruct {
